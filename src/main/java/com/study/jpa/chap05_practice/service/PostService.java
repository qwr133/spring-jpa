...
@Transactional //jpa 레파짓토리를 사용하는 빈은 반드시 트랜잭션 아노테이션
public class PostService {
    ...
    public PostListResponseDTO getPosts(PageDTO dto) {
        ...
        Pageable pageable = PageRequest.of(
                dto.getPage() - 1, dto.getSize(), Sort.by("createDate").descending()
                //최신번호 순으로 정렬
        );
        ...
        return PostListResponseDTO.builder()
                ...
                .pageInfo(new PageResponseDTO(posts)) //전체 게시물 수는 여기에 있음
                .posts(detailList)
                .build();
